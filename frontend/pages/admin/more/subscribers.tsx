import CreateSubscriberForm from '@/components/forms/more_forms/CreateSubscriberForm'
        ...
        <div>
            <Stack>
                ...
                <CustomDataTable
                    ...
                    updateData={{
                        formNode: CreateSubscriberForm,
                        modalSize: 'lg',
                        updatingModalTitle: "Update Subscriber",
                        deletingModalTitle: "Delete Subscriber"
                    }}
                    columns={[
                        {
                            accessor: 'id',
...
Subscribers.PageLayout = AdminWrapper
